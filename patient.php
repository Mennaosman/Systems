...
session_start();
  if ($_SERVER['REQUEST_METHOD']=='POST')
   ...
   $x= $_POST['Patientname'];
   $_SESSION['Patientname']=$x;
    $p= $_POST['Patientid'];
   $_SESSION['Patientid']=$p;
   $y= $_POST['Patientage'];
  ...
  //     $c=$_SESSION['c'];
	 ...
	 $sql = "INSERT INTO patient (name ,id , age,payment_method,relative_relation ,Patienphone,department,doctor)values ('$x',$p,$y,'$pm','$b',$z,'$m','$n')";
